module github.com/dbellinghoven/docker-credential-vault-login
...
require (
	...
	github.com/morningconsult/docker-credential-vault-login v0.2.8
	...
	k8s.io/apimachinery v0.0.0-20190104073114-849b284f3b75 // indirect
